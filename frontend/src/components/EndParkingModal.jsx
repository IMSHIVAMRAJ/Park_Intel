...
function EndParkingModal({ close }) {
  ...
  return (
    <div
      className="fixed inset-0 flex justify-center items-center z-50 p-4 bg-black bg-opacity-20 backdrop-blur-sm"
